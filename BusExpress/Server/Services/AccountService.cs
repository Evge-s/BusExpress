namespace BusExpress.Server.Services;
...
public class AccountService : IAccountService
{
    ...
    // disabled email verify for development
    public async Task<AuthenticateResponse> Register(RegisterRequest model, string ipAddress)
    {
        ...
        AuthenticateRequest request = new() { Email = model.Email, Password = model.Password };

        return await Authenticate(request, ipAddress);
    }
